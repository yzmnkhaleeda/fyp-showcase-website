...
<div class="topnav">
  ...
  <a href="adminregsem.php" class="active">Register Semester</a>
...
<div class="row">
  <div class="column middle">
    ...
    <div>
      <h1 align="center">Semester Registration </h1>
	</div>
    
    <div style="max-width: 55%; margin: 0 auto; margin-bottom: 40px;">
      <form action="" method="post">
        <label for="semname">Semester</label>
        <input type="text" id="semname" name="semname" placeholder="e.g: semester 5/2025" required>
...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO semester (semname)
              VALUES ('$semname')";

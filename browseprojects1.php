...
<title>Browse Projects - Semester 5/2025</title>
...
<div class='row'>
  ...
  <div class='leftcolumn'>
    <div class='card'>
      <ul>
        <li><a href='browseprojects1.php' class='active'>Semester 5/2025</a></li>
        <li><a href='browseprojects2.php'>Semester 4/2025</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class='rightcolumn'>
    ...
    <div class='topnav'>
      <a href='browseprojects1.php' class='active'>Semester</a>
      <a href='browseprojects3.php'>Faculty</a>
    </div>

    <h1 align='center'>Semester 5/2025 Projects</h1>
    ...
    $sql = "SELECT project.pjid, project.pjtitle, project.pjabstract, project.pjposter, project.pjvideo,
            ...
            WHERE semester.semname='semester 5/2025' AND project.pjstatus='Approved'
    ...
    ?>
        ...
        <div class='card'>
          ...
          <table style='width:100%; border-collapse:collapse;'>
            <tr>
              <td style='width:160px; padding:6px 8px;'><strong>Abstract</strong></td>
              <td style='padding:6px 8px;'><?php echo $pjabstract != '' ? $pjabstract : 'No abstract provided.'; ?></td>
            </tr>
            <tr>
    ...
    <?php
      ...
      echo "<div class='card'><p>No projects found for this semester.</p></div>";
    }
    ?>
  </div>
</div>

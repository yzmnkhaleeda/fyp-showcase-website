...
<title>Browse Projects - FBM</title>
...
<div class='row'>
  ...
  <div class='leftcolumn'>
    <div class='card'>
      <ul>
        <li><a href='browseprojects3.php'  class='active'>Faculty of Business & Management</a></li>
        <li><a href='browseprojects4.php'>Faculty of Information Technology & Multimedia</a></li>
  ...
  <div class='rightcolumn'>
    ...
    <h1 align='center'>Faculty of Business & Management Projects</h1>
    ...
    $sql = "SELECT project.pjid, project.pjtitle, project.pjabstract, project.pjposter, project.pjvideo,
            ...
            WHERE student.stdfac='Faculty of Business & Management' 

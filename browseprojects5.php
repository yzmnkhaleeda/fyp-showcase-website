...
<title>Browse Projects - FHS</title>
...
<div class='row'>
  ...
  <div class='leftcolumn'>
    <div class='card'>
      <ul>
        ...
        <li><a href='browseprojects4.php'>Faculty of Information & Technology</a></li>
        <li><a href='browseprojects5.php'  class='active'>Faculty of Health & Science</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class='rightcolumn'>
    ...
    <h1 align='center'>Faculty of Health & Science Projects</h1>
    ...
    $sql = "SELECT project.pjid, project.pjtitle, project.pjabstract, project.pjposter, project.pjvideo,
            ...
            WHERE student.stdfac='Faculty of Health & Science' 

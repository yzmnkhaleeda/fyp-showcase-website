...
session_start();
		...
		{
			$lectuser = mysqli_real_escape_string($db,$_POST['lectuser']);
		    $lectpass = mysqli_real_escape_string($db,$_POST['lectpass']);
			
			$query = mysqli_query($db,"SELECT * FROM lecturer WHERE lectuser='$lectuser' AND lectpass ='$lectpass'") or die (mysqli_error($db));
			$count = mysqli_num_rows($query);
				...
				while($result = mysqli_fetch_array($query,MYSQLI_ASSOC))
				{
					...
					if($count == 1)
					{
					    $_SESSION['lecturer'] = $result['lectid'];
...
<div class="topnav">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="lectlogin.php" class="active">Lecturer Login</a>
...
<div class="row">
  <div class="column middle">
    <h1 style="text-align: center;">Lecturer Login</h1>

    <form method="post">
        <table align="center">
            <tr>
                <td width="30">Username</td>
                <td><input type="text" name="lectuser" placeholder="username"></td>
            </tr>
            <tr>
                <td width="30">Password</td>
                <td><input type="password" name="lectpass" placeholder="password"></td>
            </tr>
            <tr>

...
session_start();
		...
		{
			$stduser = mysqli_real_escape_string($db,$_POST['stduser']);
		    $stdpass = mysqli_real_escape_string($db,$_POST['stdpass']);
			
			$query = mysqli_query($db,"SELECT * FROM student WHERE stduser='$stduser' AND stdpass ='$stdpass'") or die (mysqli_error($db));
...
<div class="topnav">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="stdlogin.php" class="active">Student Login</a>
    </div>
  </div>
    ...
    <form method="post">
        <table align="center">
            <tr>
                ...
                <td><input type="text" name="stduser" placeholder="username"></td>
            </tr>
            <tr>
                <td width="30">Password</td>
                <td><input type="password" name="stdpass" placeholder="password"></td>
            </tr>
            <tr>

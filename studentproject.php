...
<div class="topnav">
  ...
  <a href="studentproject.php" class="active">Project Abouts</a>
...
<?php
$res2 = mysqli_query($db, "SELECT student.*, lecturer.lectname, semester.semname 
                          FROM student 
                          LEFT JOIN lecturer ON student.lectid = lecturer.lectid 
                          LEFT JOIN semester ON student.semid = semester.semid 
                          WHERE student.stdid=" . $_SESSION['student']) 
                          or die(mysqli_error($db));
$userRow2 = mysqli_fetch_array($res2);

$res3 = mysqli_query($db, "SELECT * FROM project WHERE stdid=" . $_SESSION['student']) or die(mysqli_error($db));
...
?>
    ...
    <div style="max-width: 55%; margin: 0 auto; margin-bottom: 40px;">
      <form>
        ...
        <input type="text" value="<?php echo $lectname; ?>" readonly>
        ...
        <label>Status</label>
        <input type="text" value="<?php echo $pjstatus; ?>" readonly>
